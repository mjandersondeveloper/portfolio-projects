; ModuleID = 'fuzz3.instrumented.ll'
...
entry:
  ...
  %1 = zext i1 %cmp to i32, !dbg !20
  call void @__cbi_branch__(i32 28, i32 7, i32 %1)
...
entry:
  ...
  tail call void @__coverage__(i32 42, i32 7)
  %1 = zext i1 %cmp to i32, !dbg !48
  call void @__cbi_branch__(i32 42, i32 7, i32 %1)
  br i1 %cmp, label %if.then, label %if.end, !dbg !48

if.then:                                          ; preds = %entry
  tail call void @__coverage__(i32 43, i32 9)
  %2 = load i32, i32* %y, align 4, !dbg !49
  tail call void @__coverage__(i32 43, i32 13)
  %3 = load i32, i32* %x, align 4, !dbg !51
  tail call void @__dbz_sanitizer__(i32 %3, i32 43, i32 11)
  tail call void @__coverage__(i32 43, i32 11)
  %div = sdiv i32 %2, %3, !dbg !52
...
if.end9:                                          ; preds = %if.then7, %if.end
  ...
  call void @__cbi_return__(i32 50, i32 7, i32 %call11)
  tail call void @__coverage__(i32 50, i32 7)
  %tobool = icmp ne i32 %call11, 0, !dbg !69
  tail call void @__coverage__(i32 50, i32 7)
  %7 = zext i1 %tobool to i32, !dbg !70
  call void @__cbi_branch__(i32 50, i32 7, i32 %7)
  br i1 %tobool, label %if.then12, label %if.end14, !dbg !70

if.then12:                                        ; preds = %if.end9
  tail call void @__coverage__(i32 51, i32 9)
  %8 = load i32, i32* %y, align 4, !dbg !71
  tail call void @__coverage__(i32 51, i32 13)
  %9 = load i32, i32* %x, align 4, !dbg !73
  tail call void @__dbz_sanitizer__(i32 %9, i32 51, i32 11)
  tail call void @__coverage__(i32 51, i32 11)
  %div13 = sdiv i32 %8, %9, !dbg !74
...
declare void @__cbi_branch__(i32, i32, i32)

declare void @__cbi_return__(i32, i32, i32)
...
!1 = !DIFile(filename: "fuzz3.c", directory: "/home/cs6340/cbi/test")
!2 = !{}
