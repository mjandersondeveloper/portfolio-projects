; ModuleID = 'fuzz1.instrumented.ll'
...
entry:
  ...
  tail call void @__coverage__(i32 33, i32 7)
  %1 = zext i1 %cmp to i32, !dbg !31
  call void @__cbi_branch__(i32 33, i32 7, i32 %1)
...
if.end:                                           ; preds = %if.then, %entry
  ...
  tail call void @__coverage__(i32 37, i32 7)
  %4 = zext i1 %cmp6 to i32, !dbg !43
  call void @__cbi_branch__(i32 37, i32 7, i32 %4)
...
if.then7:                                         ; preds = %if.end
  ...
  %6 = load i32, i32* %x, align 4, !dbg !46
  tail call void @__coverage__(i32 38, i32 13)
...
!1 = !DIFile(filename: "fuzz1.c", directory: "/home/cs6340/cbi/test")
!2 = !{}
