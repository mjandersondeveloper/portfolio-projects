; ModuleID = 'fuzz2.instrumented.ll'
...
entry:
  ...
  call void @__cbi_return__(i32 42, i32 7, i32 %call2)
  tail call void @__coverage__(i32 42, i32 7)
  %tobool = icmp ne i32 %call2, 0, !dbg !45
  tail call void @__coverage__(i32 42, i32 7)
  %1 = zext i1 %tobool to i32, !dbg !46
...
if.then:                                          ; preds = %entry
  ...
  %2 = load i32, i32* %y, align 4, !dbg !47
...
!1 = !DIFile(filename: "fuzz2.c", directory: "/home/cs6340/cbi/test")
!2 = !{}
