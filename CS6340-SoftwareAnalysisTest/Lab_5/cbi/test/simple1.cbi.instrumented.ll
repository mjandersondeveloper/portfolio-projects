...
entry:
  ...
  call void @__cbi_return__(i32 28, i32 3, i32 %call)
  ...
  tail call void @__coverage__(i32 29, i32 7)
  %1 = zext i1 %cmp to i32, !dbg !21
  call void @__cbi_branch__(i32 29, i32 7, i32 %1)
...
if.end:                                           ; preds = %if.else, %if.then
  ...
  %cmp1 = icmp slt i32 %2, 1, !dbg !27
  tail call void @__coverage__(i32 33, i32 7)
  %3 = zext i1 %cmp1 to i32, !dbg !28
  call void @__cbi_branch__(i32 33, i32 7, i32 %3)
...
if.then2:                                         ; preds = %if.end
  ...
  tail call void @__dbz_sanitizer__(i32 %5, i32 34, i32 11)
...
!1 = !DIFile(filename: "simple1.c", directory: "/home/cs6340/cbi/test")
!2 = !{}
