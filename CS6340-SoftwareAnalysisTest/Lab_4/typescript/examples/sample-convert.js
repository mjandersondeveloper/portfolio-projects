...
/* This file is a sample JavaScript file to show how to convert JavaScript to TypeScript when a type error is present */
function convert() {
    var message = "42";
    var count = 8;
    var combined = message + count;
    var converted = parseInt(combined);
    return converted;
}
