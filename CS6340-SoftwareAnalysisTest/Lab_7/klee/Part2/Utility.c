...
int main(int argc, char** a2, char** a3) {
	int cb = 0;
	long int argSize = a2[1] ? strlen(a2[1]) : 0;

	klee_assume(argSize > 2);
	klee_assume((a2[1][0] == '-') & (a2[1][1] == 'g' | a2[1][1] == 'o' | a2[1][1] == 't' | a2[1][1] == 'c' | a2[1][1] == 'h' | a2[1][1] == 'a' | a2[1][1] == 'x') & (a2[1][strlen(a2[1])-1] == '-'));
